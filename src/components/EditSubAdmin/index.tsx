...
export default function EditSubAdmin(props:EditSubAdminProps) {
...
const handleEdit = async () => {
    try {
      ...
      formData.set("username", editFormData?.username || "");
      ...
      const response = await axios.put(
        `https://yoyo560live.live/admin/bd/update/${editFormData?.id}`,
        formData,
        {
          headers: {
