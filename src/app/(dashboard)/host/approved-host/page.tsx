...
const ViewAgency = () => {
  ...
  const headerData = [
    ...
    },
    {
      ...
      renderCell: (rowData: UserData) => (
          ...
          <p className="text-[14px] text-green-600 font-semibold">{rowData?.status}</p>
      )
    },
    ...
    try {
      ...
      if(data?.status ===1){
        ...
        setOpenToast(true);
         ...
         setToastObj({
          title:"Host",
           desc:"Host Deleted Successfully",
           variant:"success"
  ...
  <div className="mt-20 p-4 h-auto ">
    ...
    data={userData} headers={headerData} title="Approved Host" />
    <ModalComponent
