...
const Page=({ params }: { params: { id: string } })=> {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`https://yoyo560live.live/user/send/gift/get/${params?.id}`, {
                method: "GET",
                headers: {
        ...
        <nav className="flex items-center h-full">
          <Title size="lg" variant="default">
            ...
            <div className="h-screen w-full flex justify-center items-center">
                ...
                <div className="p-4">
                   {
                    data.length===0 ? <div className="text-center h-screen flex justify-center items-center text-gray-500 py-4">No Data Available</div>: <div className="mb-6 overflow-x-auto overflow-y-auto" style={{ maxHeight: "calc(100vh - 240px)" }}>
